...
#define SCROLL_VERTICAL				FALSE	// Solo scroll horizontal
// Source data info (mapa del laberinto: 64x24 tiles)
#define SCROLL_SRC_X				0		// Start X coordinate of the source data
#define SCROLL_SRC_Y				0		// Start Y coordinate of the source data
#define SCROLL_SRC_W				64		// Width of the source data  (= TILE_COLS)
#define SCROLL_SRC_H				24		// Height of the source data (= TILE_ROWS)
// Destination data info (pantalla completa)
#define SCROLL_DST_X				0		// Destination x coordinate (in layout table)
#define SCROLL_DST_Y				0		// Destination y coordinate (in layout table)
#define SCROLL_DST_W				32		// Destination width
#define SCROLL_DST_H				24		// Destination height
#define SCROLL_SCREEN_W				32		// Screen width in tile number
// Sin envoltura: el mapa es finito y la camara se limita a sus bordes
#define SCROLL_WRAP					FALSE
// Ajuste por pixel con R#18 del V9938/V9958 (scroll horizontal suave)
#define SCROLL_ADJUST				TRUE	// Global ajustement
#define SCROLL_ADJUST_SPLIT			FALSE	// Sin split de pantalla (no hay HUD que proteger)
// Sin mascara de sprites (evita forzar escala x2 en los sprites -> el comecocos
// se mantiene a 16x16). Posible franja de <=7px en un borde, disimulada por el marco.
